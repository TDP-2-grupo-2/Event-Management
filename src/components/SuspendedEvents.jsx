...
export const SuspendedEvents = (props) => {
    ...
    async function getOrganizerEvents(token){
        ...
        console.log(token)
        const url = `${APIURL}/organizers/events?status=suspended`;
    ...
    return (
        !loading ? 
        <div className="SuspendedEvents" style={{background: "rgba(137,152,202,255)"}}>
